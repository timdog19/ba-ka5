    ...
    <>
      <s.Body>
        ...
        >
          <s.Mint>
            ...
            <s.FlexContainer fd={"row"} ai={"center"} jc={"space-between"}>
              ...
              <s.AmountContainer ai={"center"} jc={"center"} fd={"row"}>
                ...
                <s.SpacerMedium />
                <s.TextDescription color={"#d2ae34"} size={"2.5rem"}>
                  {mintAmount}
                </s.TextDescription>
                <s.SpacerMedium />
                <StyledRoundButton
            ...
            <s.FlexContainer fd={"row"} ai={"center"} jc={"end"}>
              <s.maxButton
            ...
            <s.FlexContainer fd={"row"} ai={"center"} jc={"space-between"}>
              ...
              <s.TextTitle color={"#d2ae34"}>{displayCost}</s.TextTitle>
            </s.FlexContainer>
            <s.SpacerSmall />
            <s.Line />
            <s.SpacerSmall />
          ...
          <s.CatDiv  >
            <s.Image src={"config/images/lord.png"} wid={40} />
            <s.TextDescription>
              Each owner of the Kotilingam will become part of the Kotilingam community where they will enjoy exclusive benefits like access to major events like Yoga, Meditation, Retreats, music festivals, conferences and concerts.
            </s.TextDescription>
          </s.CatDiv>
        </s.FlexContainer>
      </s.Body>
